...
namespace ScientificResearch.ViewModel
{
    ...
    {
        public static ContinuingEducationRecordTransferObject ToDataTransferObjectModel(this ContinuingEducationRecordViewModel domainModel)
        {
        ...
        public static ContinuingEducationRecordViewModel ToViewModel(this ContinuingEducationRecordTransferObject model)
        {
            return new ContinuingEducationRecordViewModel
            {
                Id = model.Id,
                UserId = model.UserId,
