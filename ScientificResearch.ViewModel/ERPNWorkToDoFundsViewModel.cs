...
{
    public class ERPNWorkToDoFundsViewModel
    {
        public ERPNWorkToDoFundsViewModel()
        {
            NWorkToDoFundsList = new List<FundsThresholdViewModel>();
        }
        ...
        //public Nullable<DateTime> ProjectEstablishTime { get; set; }
         ...
         public IList<FundsThresholdViewModel> NWorkToDoFundsList { get; set; }
    }
}
